                      ...
                      if ($checkuser==0) {// si no existe el usuario
                        ...
                        if ($checkuser_programa==0) {// si no existe programa relacionado con el usuario
                         ...
                         if ($checkinscripcion==0) {// si no existe la inscripcion
                             ...
                             $sql="INSERT INTO inscripcion (user_id, campus_id,periodo_id,modalidad_id, institucion_destino_id, tipo, estado_id,programa_origen_id, migration ) 
                             values ($user_id,$campus_origen_id, $periodo_id, $programacion_modalidad_id,$institucion_id, 0, 3, $programa_id, 1 );";
                           $inscripcion_id=$inserts->InsertGeneral($sql);
                             ...
                             $countexisteinsrip++;
                             $msj="No. $countexisteinsrip ; ya estiste la inscripción con el id; $inscripcion_id  estudiante; $nombres   $apellidos ci; $num_docu user_id; $user_id periodo_id; $periodo_id modalidad; $programacion_modalidad_id institucion_id; $institucion_id <br>";
                             $existe.="<table class='table table-bordered'><tr><td><br>$msj<br></td></tr></table>";
                             $log->error("  \r\n".$msj." \r\n");
                        }
                         ...
                         if(!empty($fuentes_financiacion)){
                          ...
                          /*   echo '<pre>';
                            var_dump( $checkfinanciacion, $periodo_id, $modalidad_id, $institucion_id, $campus_origen_id, $campus_destino_id, 
                            $programacion_modalidad_id, $user_id, $facultad_id, $programa_id, $programa_user_id,  $campus_user_id, $inscripcion_id, $fuente_financiacion_id, $financiacion_id); die;
              */           }
                            echo  $output;                
